    ...
    return (
        <div id='basic1_wrap'>
            ...
            <div id='basic1_container3'>
                <img src='signature-bed-image/basic1_con3.jpg' alt='con3'/>
            ...
            <div id='basic1_container5'>
                <img src='signature-bed-image/basic1_con5.jpg' alt='con5'/>
            </div>
            <div id='basic1_container6'>
                <img src='signature-bed-image/basic1_con6.jpg' alt='con6'/>
            </div>
            <div id='basic1_container7'>
                <div id='basic1_container7_txt'>
                    <h1>숙면을 지킬 수 있는 모든 가치를 담아</h1>
                    <span>편안함, 안정성, 스타일로 고유의 품격을 완성합니다<br/>
                    고객을 배려하는 퀄리티로 최상의 숙면을 선사합니다</span>
                </div>
                <img src='signature-bed-image/basic1_con7.jpg' alt='con7'/>
            </div>
