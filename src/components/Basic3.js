        ...
        <div id='basic3_wrap'>
            <div id='basic3_hd'>
                <div className='hd_left'>
                    <strong>SIGNATURE BASIC FOLDING 5T</strong>
                    <p>S/SS/Q</p>
                </div>
                <div className='hd_right'>
                    <span>400,000 ~</span>
                    <a href='https://smartstore.naver.com/sleepnsleep/products/5329205038?utm_source=SIGNATURE&utm_medium=evezary&utm_content=%26utm_content%3D%7Bkeyword%7D&utm_campaign=%EC%82%BC%EB%8B%A8' target='_blank'>
                    <div>구매하기</div></a>
                </div>
            </div>
            <div id='basic3_container1'>
                <div id='basic3_con1'>
                    <h1 className='ani_fir'>To smart person</h1><br/>
                    <h1 className='ani_sec'>“Reasonable choice of smart people”</h1>
                </div>
                <img src='signature-bed-image/basic3_con1.jpg' alt='con1'/>
            </div>
            <div id='basic3_container2'>
            ...
            <div id='basic3_container3'>
                <img src='signature-bed-image/basic3_con3.jpg' alt='con3'/>
            ...
            <div id='basic3_container4'>
                <img src='signature-bed-image/basic3_con4.jpg' alt='con4'/>
            </div>
            <div id='basic3_container5'>
                <img src='signature-bed-image/basic3_con5.jpg' alt='con5'/>
            </div>
            <div id='basic3_container6'>
                <img src='signature-bed-image/basic3_con6.jpg' alt='con6'/>
            </div>
            <div id='basic3_container7'>
                <div id='basic3_container7_txt'>
                    <h1>숙면을 지킬 수 있는 모든 가치를 담아</h1>
                    <span>편안함, 안정성, 스타일로 고유의 품격을 완성합니다<br/>
                    고객을 배려하는 퀄리티로 최상의 숙면을 선사합니다</span>
                </div>
                <img src='signature-bed-image/basic3_con7.jpg' alt='con7'/>
            </div>
            <div className='prd_info'>
                ...
                <div>
                    ...
                    <details>
                        ...
                        <ul className='subMenu'>
                            <li>내부 : 시그니처 메모리폼 2.5T+ 시그니처 서포트폼 2.5T</li>
