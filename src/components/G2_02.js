        ...
        <div id='g2_02_wrap'>
            <div id='g2_02_hd'>
                <div className='hd_left'>
                    <strong>SIGNATURE G2 6T</strong>
                    <p>S/SS/Q</p>
                </div>
                <div className='hd_right'>
                    <span>630,000 ~</span>
                    <a href='https://smartstore.naver.com/sleepnsleep/products/5326883097?utm_source=SIGNATURE&utm_medium=evezary&utm_content=%26utm%5Fcontent%3D%7Bkeyword%7D&utm_campaign=6t' target='_blank'>
                    <div>구매하기</div></a>
                </div>
            </div>
            <div id='g2_02_container1'>
                <div id='g2_02_con1'>
                    <h1 className='ani_fir'>To passionate person</h1><br/>
                    <h1 className='ani_sec'>“Excellent choice of passionate people”</h1>
                </div>
                <img src='signature-bed-image/g2_02_con1.jpg' alt='con1'/>
            </div>
            <div id='g2_02_container2'>
            ...
            <div id='g2_02_container3'>
                <img src='signature-bed-image/g2_02_con3.jpg' alt='con3'/>
            ...
            <div id='g2_02_container4'>
                <img src='signature-bed-image/g2_02_con4.jpg' alt='con4'/>
            </div>
            <div id='g2_02_container5'>
                <img src='signature-bed-image/g2_02_con5.jpg' alt='con5'/>
            </div>
            <div id='g2_02_container6'>
                <img src='signature-bed-image/g2_02_con6.jpg' alt='con6'/>
            </div>
            <div id='g2_02_container7'>
                <div id='g2_02_container7_txt'>
                    <h1>숙면을 지킬 수 있는 모든 가치를 담아</h1>
                    <span>편안함, 안정성, 스타일로 고유의 품격을 완성합니다<br/>
                    고객을 배려하는 퀄리티로 최상의 숙면을 선사합니다</span>
                </div>
                <img src='signature-bed-image/g2_02_con7.jpg' alt='con7'/>
            </div>
